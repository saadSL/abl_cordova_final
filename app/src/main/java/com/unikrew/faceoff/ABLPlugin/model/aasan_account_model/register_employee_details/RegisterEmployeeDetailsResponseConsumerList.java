...
public class RegisterEmployeeDetailsResponseConsumerList implements Serializable {
    ...
    public int countryOfBirthPlaceId;
    ...
    public int customerNonResidentInd;
    ...
    public int getCountryOfBirthPlaceId() {
        return countryOfBirthPlaceId;
    }

    public void setCountryOfBirthPlaceId(int countryOfBirthPlaceId) {
    ...
    public int getCustomerNonResidentInd() {
        return customerNonResidentInd;
    }

    public void setCustomerNonResidentInd(int customerNonResidentInd) {
