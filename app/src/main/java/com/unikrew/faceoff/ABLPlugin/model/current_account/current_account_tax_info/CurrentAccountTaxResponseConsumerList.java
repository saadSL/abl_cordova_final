...
public class CurrentAccountTaxResponseConsumerList implements Serializable {
    ...
    public ArrayList<CurrentAccountTaxResponseNationality> nationalities;
    public ArrayList<CurrentAccountTaxResponseResidentCountry> residentCountries;
    ...
    public ArrayList<CurrentAccountTaxResponseNationality> getNationalities() {
        return nationalities;
    }

    public void setNationalities(ArrayList<CurrentAccountTaxResponseNationality> nationalities) {
        this.nationalities = nationalities;
    }

    public ArrayList<CurrentAccountTaxResponseResidentCountry> getResidentCountries() {
        return residentCountries;
    }

    public void setResidentCountries(ArrayList<CurrentAccountTaxResponseResidentCountry> residentCountries) {
